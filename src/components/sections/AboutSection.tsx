...
export const AboutSection = () => {
    return (
        <section className="mt-16 md:mt-24">
            <h2 id="about" className="pb-8 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-violet-600">
                Sobre mi
            </h2>
            <article className="grid md:grid-cols-2">
                ...
                <div className="col-span-1 flex flex-col justify-center items-center gap-4">
                    ...
                    <p className="text-lg inline-flex flex-nowrap gap-2"><MailIcon/> <span>davesebastian99@gmail.com</span></p>
                    <p className="text-lg inline-flex flex-nowrap gap-2"> <PhoneCallIcon/> <span>+57 3052434484</span></p>
                    </div>
                </div>
