...
export const ExperienceItem = ({ enterprise = 'Enterprise', lapsusText = "LapsusText", tasks = [] }: Props) => {
    return (
        <li className="mb-10 ms-6">
            ...
            <div className="pl-4">
                <h3 className="flex items-center mb-1 text-lg sm:text-3xl font-semibold text-gray-900 dark:text-white">{enterprise} <span className="hidden bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span></h3>
